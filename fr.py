...
db[1].append(cv2.imread('BadFace/2.jpg',0))
db[1].append(cv2.imread('BadFace/3.jpg',0))
db[1].append(cv2.imread('BadFace/4.jpg',0))
db[1].append(cv2.imread('BadFace/5.jpg',0))
db[1].append(cv2.imread('BadFace/6.jpg',0))
